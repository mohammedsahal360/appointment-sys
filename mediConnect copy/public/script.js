...
function signclick() {
    ...
    const url = isSigned(isSignUp) ? 'http://192.168.100.223:3000/register' : 'http://192.168.100.223:3000/login';
...
document.addEventListener("DOMContentLoaded", () => {
    fetch('http://192.168.100.223:3000/check-auth')
        .then(response => response.json())
        .then(data => {
            if (data.isSigned) {
...
async function loadAllHospitals(placeId){
    try{
        const response = await fetch(`http://192.168.100.223:3000/api/hospitals/${placeId}`);
...
async function loadAllSpecialities(placeId){
    try{
        const response = await fetch(`http://192.168.100.223:3000/api/specialities/${placeId}`);
...
async function getSpeciality(id){
    const response = await fetch(`http://192.168.100.223:3000/api/speciality/${id}`);
...
async function getHospital(id){
    const response = await fetch(`http://192.168.100.223:3000/api/hospital/${id}`);
...
async function loadAllDoctors(placeId){
    const response = await fetch(`http://192.168.100.223:3000/api/doctors/${placeId}`);
...
async function loadSlots(doctorId){
    try{
        ...
        const response = await fetch(`http://192.168.100.223:3000/api/slots/${doctorId}`);
