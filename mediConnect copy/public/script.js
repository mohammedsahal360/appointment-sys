...
function signclick() {
    ...
    const url = isSigned(isSignUp) ? 'https://mediconnect-dfg1.onrender.com/register' : 'https://mediconnect-dfg1.onrender.com/login';
...
document.addEventListener("DOMContentLoaded", () => {
    fetch('https://mediconnect-dfg1.onrender.com/check-auth')
        .then(response => response.json())
        .then(data => {
            if (data.isSigned) {
...
async function loadAllHospitals(placeId){
    try{
        const response = await fetch(`https://mediconnect-dfg1.onrender.com/api/hospitals/${placeId}`);
...
async function loadAllSpecialities(placeId){
    try{
        const response = await fetch(`https://mediconnect-dfg1.onrender.com/api/specialities/${placeId}`);
...
async function getSpeciality(id){
    const response = await fetch(`https://mediconnect-dfg1.onrender.com/api/speciality/${id}`);
...
async function getHospital(id){
    const response = await fetch(`https://mediconnect-dfg1.onrender.com/api/hospital/${id}`);
...
async function loadAllDoctors(placeId){
    const response = await fetch(`https://mediconnect-dfg1.onrender.com/api/doctors/${placeId}`);
...
async function loadSlots(doctorId){
    try{
        ...
        const response = await fetch(`https://mediconnect-dfg1.onrender.com/api/slots/${doctorId}`);
